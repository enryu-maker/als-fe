        ...
        <div className='w-full h-full flex justify-center items-center'>
            ...
            <div className=' w-[68%] flex flex-col items-center my-10'>
                ...
                <div className='my-8 self-start'>
                    <h1 className='text-2xl font-Montserrat font-bold'>Similar Homes You May Like</h1>
                </div>
                <div className='my-8 self-start'>
                    <h1 className='text-2xl font-Montserrat font-bold'>New Listings near 910 Buckingham Cir NW</h1>
                </div>
